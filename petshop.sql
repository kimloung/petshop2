...
('SP120', 'Cóng ăn thủy tinh chim cảnh', 'chim4.jpg', 99, 25000, 'cóng ăn thủy tinh cho chim cảnh\r\n\r\nCóng ăn chào mào,mi ,choè...'),
('SP121', 'Cóng sứ chào mào', 'chim3.jpg', 80, 30000, 'Cóng sứ chào mào, chất liệu sứ cao cấp thích hợp cho chào mào than mi lửa...'),
...
('SP124', 'Lồng chim đôi', 'chim7.jpg', 18, 200000, 'Lồng chim cảnh lắp ghép loại rộng 1 mét (100cmx50cmx50cm)\r\n\r\nĐỦ PHỤ KIỆN\r\n\r\nLồng thú cưng bằng kẽm'),
('SP125', 'Thức ăn dinh dưỡng hàng ngày cho hamster', 'hamster1.jpg', 32, 30000, 'THỨC ĂN DINH DƯỠNG HÀNG NGÀY CHO HAMSTER - Gói thức ăn đầy đủ dưỡng chất cần thiết cho các bé Hamster\r\n\r\nGiá: 30k/gói\r\n\r\nGói Thức Ăn Trộng Dinh Dưỡng Hằng Ngày cho Hamster được trộn theo tỷ lệ nhất định bao gồm nhiều loại ngũ cốc, hạt khô, thức ăn tổng hợp... mang lại đầy đủ nhu cầu dưỡng chất cho các bé Hamster ăn mỗi ngày.'),
('SP126', 'Ngũ cốc trộn', 'hamster2.jpg', 6, 15000, ''),
('SP127', 'Mùn cưa hương dâu', 'hamster3.jpg', 33, 18000, 'Mùn cưa lót chuồng cho Hamster'),
('SP128', 'Bánh xe chạy', 'hamster5.jpg', 46, 52000, '_ Vật liệu : Phần khung được làm bằng nhựa cứng bền chắc , kết cấu đơn giản và độ ổn định cao. Phần bánh xe được ghép lại từ dải nhựa mềm dẻo liền mạch không có khe hở dảm bảo an toàn cao cho các bé hamster có thể hình nhỏ.\r\n\r\n_ Sử dụng : Với khung có chân cố định rất tiện lợi nếu bạn chọn loại bánh xe chạy này cho loại lồng kính hoặc lồng bằng nhựa mica. Đường kính bánh xe là 12,5 cm thuộc diện trung bình thích hợp nhất với các bé hamster có thể hình nhỏ như winter white hay campbell’s. Vì toàn bộ bánh xe đều làm bằng nhựa nên sau thời gian dài không xuất hiện rỉ sét, nguyên nhân lớn nhất gây ra tiếng ồn khi các bé hamster sử dụng wheel . Màu sắc đa dạng bắt mắt nên các bé hamster sẽ rất thích thú chạy trên loại wheel này.'),
('SP129', 'Nấm gỗ thông 3 tầng', 'hamster4.jpg', 33, 130000, '_ Vật liệu : Làm bằng gỗ thông tự nhiên , không dùng bất cứ đinh kim loại nào , gỗ thô thiên nhiên phù hợp cho chuột của bạn .\r\n\r\n_ Sử dụng : Đây là sản phẩm đồ chơi cho chuột Hamster . Bạn có thể đặt trong lồng cho chú Hmaster leo trèo , luốn lách , chơi đùa trên đó . Đây sẽ là món đồ chơi mà chú chuột của bạn sẽ rất thích thú đùa nghịch trên đó . Món đồ chơi thiên nhiên sẽ tạo cảm giác thoải mái cho chú hamster .'),
...
('SP43', 'Xịt khử mùi diệt khuẩn Natural clean', 'suatam5.jpg', 31, 200000, 'Hầu hết mọi người đều sử dụng sản phẩm khử mùi, diệt khuẩn trong không gian sinh hoạt chung của gia đình. Nếu sản phẩm này được làm từ các thành phần hóa học sẽ rất có hại cho sức khỏe các thành viên trong gia đình cũng như vật nuôi.'),
